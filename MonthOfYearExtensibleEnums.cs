namespace EnumTests
{
    ...
    {
        private MonthOfYearExtensibleEnums(string value)
        {
            Value = value;
        }

        public static implicit operator MonthOfYearExtensibleEnums(string value) 
        { 
            var baseType = GetBaseTypeForAllowedType(value);
            return (baseType == null)? new MonthOfYearExtensibleEnums(value): (MonthOfYearExtensibleEnums)baseType;
        }
        ...
        public override bool Equals(object obj) => this.Equals(((MonthOfYearExtensibleEnums)obj));
